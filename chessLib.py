...
def GetPieceLegalMoves(board, position):
        ...
        if piece == 11 or piece == 21:
                ...
                if position%8 != 6 and position%8 != 7:
                    potential = potential + [position+17, position+10, position-6, position-15]
                elif position%8 != 7:
                    potential = potential + [position+17, position-15]
                
                if position%8 != 1 and position%8 != 0:
                    potential = potential + [position+15, position+6, position-10,position-17]
                elif position%8 != 0:
                    potential = potential + [position-17, position+15]
...
def minimax(move_node, depth, max_depth, player, isMaxPlayer, alpha, beta, board):
    ...
    if isMaxPlayer == True:
        ...
        for i in move_list:
            ...
            max_rating = (minimax(move_subnode, depth+1, max_depth, player, False, alpha, beta, testboard))
    ...
    if isMaxPlayer == False:
        ...
        for i in move_list:
            ...
            rating = rateBoard(testboard, player)
            move_subnode = chessPlayer_tree.tree([i,rating])
            min_rating = (minimax(move_subnode, depth+1, max_depth, player, True, alpha, beta, testboard))
...
-10,-20,-20,-20,-20,-20,-20,-10,
 ...
 20, 30, 10,  0,  0, 10, 30, 20]
    ...
    if player == 2:
        ...
        pawnbonus = [0, 0, 0, 0, 0, 0, 0, 0, 5, 10, 10, -20, -20, 10, 10, 5, 5, -5, -10, 0, 0, -10, -5, 5, 0, 0, 0, 20, 20, 0, 0, 0, 5, 5, 10, 25, 25, 10, 5, 5, 10, 10, 20, 30, 30, 20, 10, 10, 50, 50, 50, 50, 50, 50, 50, 50, 0, 0, 0, 0, 0, 0, 0, 0]

        knightbonus = [-50, -40, -30, -30, -30, -30, -40, -50, -40, -20, 0, 5, 5, 0, -20, -40, -30, 5, 10, 15, 15, 10, 5, -30, -30, 0, 15, 20, 20, 15, 0, -30, -30, 5, 15, 20, 20, 15, 5, -30, -30, 0, 10, 15, 15, 10, 0, -30, -40, -20, 0, 0, 0, 0, -20, -40, -50, -40, -30, -30, -30, -30, -40, -50]
    
        bishopbonus = [-20, -10, -10, -10, -10, -10, -10, -20, -10, 5, 0, 0, 0, 0, 5, -10, -10, 10, 10, 10, 10, 10, 10, -10, -10, 0, 10, 10, 10, 10, 0, -10, -10, 5, 5, 10, 10, 5, 5, -10, -10, 0, 5, 10, 10, 5, 0, -10, -10, 0, 0, 0, 0, 0, 0, -10, -20, -10, -10, -10, -10, -10, -10, -20]

        rookbonus = [0, 0, 0, 5, 5, 0, 0, 0, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, -5, 0, 0, 0, 0, 0, 0, -5, 5, 10, 10, 10, 10, 10, 10, 5, 0, 0, 0, 0, 0, 0, 0, 0]

        queenbonus = [-20, -10, -10, -5, -5, -10, -10, -20, -10, 0, 0, 0, 0, 5, 0, -10, -10, 0, 5, 5, 5, 5, 5, -10, -5, 0, 5, 5, 5, 5, 0, 0, -5, 0, 5, 5, 5, 5, 0, -5, -10, 0, 5, 5, 5, 5, 0, -10, -10, 0, 0, 0, 0, 0, 0, -10, -20, -10, -10, -5, -5, -10, -10, -20]

        kingbonus = [20, 30, 10, 0, 0, 10, 30, 20, 20, 20, 0, 0, 0, 0, 20, 20, -10, -20, -20, -20, -20, -20, -20, -10, -20, -30, -30, -40, -40, -30, -30, -20, -30, -40, -40, -50, -50, -40, -40, -30, -30, -40, -40, -50, -50, -40, -40, -30, -30, -40, -40, -50, -50, -40, -40, -30, -30, -40, -40, -50, -50, -40, -40, -30]
